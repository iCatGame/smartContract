...
const main = async () => {
    ...
    const nftFactory = await ethers.getContractFactory("gameWithAIGC");
    const nftContract = await nftFactory.deploy();
    await nftContract.deployed();
    console.log('NFT contract deployed to:', nftContract.address);

    // const upgradableFactory = await ethers.getContractFactory("TransparentUpgradeableProxy");
    ...
    const upgradableContract = await upgrades.deployProxy(nftContract)
